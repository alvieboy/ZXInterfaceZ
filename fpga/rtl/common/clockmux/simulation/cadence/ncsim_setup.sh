...
TOP_LEVEL_NAME="clockmux"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/alvieboy/intelFPGA_lite/19.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/clockmux_altclkctrl_0.vhd" -work altclkctrl_0 -cdslib ./cds_libs/altclkctrl_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clockmux.vhd"                                                                                   
fi
